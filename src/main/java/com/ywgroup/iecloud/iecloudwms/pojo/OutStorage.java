...
public class OutStorage {
    ...
    public OutStorage(Integer id, String ordernum, Integer outtype, Integer producttype, String storagenum, String cusnum, String cusname, String contact, String phone, String address, String contractorder, Double num, Double amount, Double weight, Date senddate, Integer status, Integer isdelete, Date createtime, String createuser, String audituser, Date auditetime, String printuser, Date printtime, String reason, Integer operatetype, String equipmentnum, String equipmentcode, String remark) {
        this.id = id;
